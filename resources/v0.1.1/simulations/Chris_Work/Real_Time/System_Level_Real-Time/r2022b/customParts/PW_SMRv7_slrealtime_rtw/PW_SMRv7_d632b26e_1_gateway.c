...
#include "nesl_rtw.h"
#include "PW_SMRv7_d632b26e_1.h"
#include "PW_SMRv7_d632b26e_1_gateway.h"

void PW_SMRv7_d632b26e_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 0, 0.001, 0.001, 0.001, 0, 0,
    (NeModifyAbsTol) 0, 0.01, 0, 0, 0, 0, (SscLoggingSetting) 0, 712273151, 1, };
  ...
  NeSolverParameters solverparams = { 0, (NeMBLocalSolverChoice) 0, 0.001, 0, 0,
    ...
    0.01, 1, (NeLocalSolverChoice) 0, 1, 1, 0.01, 1, 3, 2, 0, 2,
  ...
  PW_SMRv7_d632b26e_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("PW_SMRv7/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
